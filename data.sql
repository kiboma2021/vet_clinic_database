...
INSERT INTO VISITS (ANIMALS_ID, VETS_ID, DATE_OF_VISIT) SELECT ANIMALS.ID, VETS.ID , '2020-05-24' FROM ANIMALS INNER JOIN VETS ON ANIMALS.NAME = 'Agumon' AND VETS.NAME = 'William Tatche';
...
INSERT INTO VISITS (ANIMALS_ID, VETS_ID, DATE_OF_VISIT) SELECT ANIMALS.ID, VETS.ID , '2020-08-10' FROM ANIMALS INNER JOIN VETS ON ANIMALS.NAME = 'Plantmon' AND VETS.NAME = 'William Tatche';
...
INSERT INTO VISITS (ANIMALS_ID, VETS_ID, DATE_OF_VISIT) SELECT ANIMALS.ID, VETS.ID , '2021-01-11' FROM ANIMALS INNER JOIN VETS ON ANIMALS.NAME = 'Blossom' AND VETS.NAME = 'William Tatche';
